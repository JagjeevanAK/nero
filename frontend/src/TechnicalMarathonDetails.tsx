    ...
    <div className="min-h-screen theme-bg theme-text py-8 px-2 md:px-10 flex items-center justify-center">
      <div className="w-full max-w-3xl glass-card rounded-2xl flex flex-col gap-6 p-6 md:p-12">
        ...
        <SectionCard>
          ...
          <p className="mb-6">
            <strong>Details:</strong> Further details related to time and venue
            will be shared soon.
          </p>
        </SectionCard>
        <SectionCard title="🏁 Technical Marathon – Event Description & Rules">
          ...
          <p className="mb-2">
            A multi-round technical treasure hunt involving coding, logic, and
            team strategy.
          </p>
          <p className="mb-2">
            Participants will progress through different levels by solving
            problems and uncovering clues to reach the next stage.
          </p>
          <div className="mb-4 p-3 rounded bg-blue-100 text-blue-900 border-l-4 border-blue-500">
            <strong>Note:</strong> All coding problems in this event will be
            based on the <b>C++ programming language</b>. Participants are
            expected to be familiar with basic to intermediate concepts of C++.
          </div>
          <h3 className="text-lg font-semibold mb-2">🧠 Round Structure</h3>
          <ul className="list-disc list-inside mb-4 theme-text-secondary">
            <li className="mb-2">
              <b>🔹 Round 1 – MCQ Test (Screening)</b>
              <br />
              Individual participants will take a technical MCQ test.
              <br />
              Based on the results, the top 40 participants will qualify for the
              next round.
              <br />
              These 40 will be randomly grouped into 10 teams (4 participants
              per team).
            </li>
            <li className="mb-2">
              <b>🔹 Round 2 – Clue Hunt (Team Round)</b>
              <br />
              Each team will solve a chain of coding or logic problems.
              <br />
              Solving a problem gives a clue to the next location or task.
              <br />
              Teams will race against each other to find and solve as many clues
              as possible.
              <br />
              The top 6 teams with the most clues solved in the shortest time
              will qualify for Round 3.
            </li>
            <li className="mb-2">
              <b>🔹 Round 3 – Final Showdown</b>
              <br />
              The 6 finalist teams will compete in a final, more challenging
              clue-solving round.
              <br />
              Based on performance, the top 2 teams will be selected.
              <br />
              The best performing team wins the Winner’s Prize; the second-best
