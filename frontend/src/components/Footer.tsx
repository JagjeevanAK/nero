  ...
  <footer className="relative py-14 px-4 mt-20 bg-gradient-to-t from-blue-950/80 via-indigo-900/60 to-transparent overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto text-center relative z-10">
      <div className="flex justify-center space-x-6 mb-8">
        <a href="https://www.instagram.com/adcet_ai?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:scale-110 transition-transform duration-300 text-pink-400 hover:text-pink-300">
          <Instagram className="w-7 h-7" />
        </a>
        <a href="https://x.com/AdcetAshta" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:scale-110 transition-transform duration-300 text-sky-400 hover:text-sky-300">
          <Twitter className="w-7 h-7" />
        </a>
        <a href="https://www.facebook.com/adcet.ac.in/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:scale-110 transition-transform duration-300 text-blue-500 hover:text-blue-400">
          <Facebook className="w-7 h-7" />
        </a>
        <a href="https://www.linkedin.com/in/adcet-ashta-631a18233" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:scale-110 transition-transform duration-300 text-blue-300 hover:text-blue-200">
